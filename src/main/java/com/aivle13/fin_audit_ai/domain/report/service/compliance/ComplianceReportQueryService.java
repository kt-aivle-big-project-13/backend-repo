...
public class ComplianceReportQueryService {

    private final ReportRepository reportRepository;
    private final FileStorageService fileStorageService;

    @Transactional(readOnly = true)
    public ComplianceReportMetadataResponse getLatest(
            Long userId,
            Long auditId,
            ReportFormat format
    ) {
        ...
        return ComplianceReportMetadataResponse.from(report);
    }
    ...
    private String createFilename(
        ...
        return "compliance-report-%d.%s".formatted(
                auditId,
                extension
        );
    }
